...
public class BST<T> {
	...
	public boolean insert(String k, T val) {
		...
		if (k.compareTo(current.key)<0) { // in case K is smaller than current.key
			current.left = tmp;
		} else {
			current.right = tmp;
		}
	...
	public boolean removeKey(String k) {
        ...
        private void inOrder(BSTNode<LinkedList<Photo>> p){
            ...
            DisplayInvertedIndexPhotos(p.data);
            inOrder(p.right);
        ...
        //helper method 
           ...
           public void DisplayInvertedIndexPhotos(LinkedList<Photo> l){
               if(l.empty()) 
